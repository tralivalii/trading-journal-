      ...
      <div className="container mx-auto p-4 md:p-8">
        <header className="flex justify-center md:justify-between items-center mb-8">
            ...
            <div className="ml-6 md:ml-0">
                <DropdownMenu 
                    trigger={
                        <button className="w-8 h-8 md:w-10 md:h-10 flex items-center justify-center bg-gray-700 rounded-full hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-blue-500 transition-colors">
